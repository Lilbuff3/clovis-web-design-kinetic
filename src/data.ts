...
export const projects: Project[] = [
  {
    ...
    year: '2026',
    image: '/images/sunday-supply.jpg',
    alt: 'Kidney Specialist Inc digital flagship for Dr. Sheikh Mohammad Masood and Dr. Mohammed Siddiqui in Madera and Fresno.',
    color: '#dbeafe',
    ink: '#1e3a8a',
    ...
    details: [
      ...
      'MedicalClinic JSON-LD schema integration for Madera and Fresno locations, driving dominant local organic search visibility.',
    ],
  ...
  },
  {
    ...
    year: '2026',
    image: '/images/form-and-field.jpg',
    alt: 'Big Bros Dumpster Rentals website design for Jessica & William Maldonado Ramirez.',
    color: '#fed7aa',
    ink: '#7c2d12',
  ...
  },
  {
    ...
    year: '2026',
    image: '/images/common-ground.jpg',
    alt: 'Clovis Web Design studio digital flagship by Adam Youssef.',
    color: '#ede4d5',
    ink: '#221d17',
